...
import in.musab.billingsoftware.entity.OrderEntity;
import in.musab.billingsoftware.entity.OrderItemEntity;
import in.musab.billingsoftware.io.*;
import in.musab.billingsoftware.repository.OrderEntityRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Double sumSalesByDate(LocalDate date) {
        return orderEntityRepository.sunSalesByDate(date);
    }
